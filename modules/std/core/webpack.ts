...
import type { WebpackModule, WebpackRequire } from "./wpunpk.mix.ts";
import type React from "npm:@types/react";

type ChunkResolver = PromiseWithResolvers<void>;
declare global {
  var CHUNKS: Record<string, ChunkResolver> & { xpui: { promise: Promise<unknown> } };
}
